        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group focus:outline-none focus:ring-2 focus:ring-amber-400 rounded-md p-1">
            <Image
              ...
              width={44}
              height={44}
              className="w-11 h-11 rounded-full object-cover border-2 border-amber-400/80 shadow-md group-hover:border-amber-300 group-hover:scale-105 transition-all"
            />
